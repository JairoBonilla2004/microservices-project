 ...
 *
 * <p>Permite modificar el nombre, la URL base y/o la clave p&uacute;blica de un
 * servicio previamente registrado. Todos los campos son opcionales; solo se
 ...
 * @param publicKey Nueva clave p&uacute;blica del servicio (opcional).
 *
